...
const checkQueue: Array<[number, number, number, string[]]> = [
  [sr, sc, dirIndex, [[sr, sc].toString()]],
];

const optimalTileSet = new Set<string>();
...
console.log(Array.from(optimalTileSet).length);
